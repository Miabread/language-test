...
static TSParseActionEntry ts_parse_actions[] = {
  ...
  [220] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_union_variant_list_repeat1, 2), SHIFT_REPEAT(76),
  [223] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_union_variant_list_repeat1, 2),
  ...
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_item, 4, .production_id = 7),
  ...
  [353] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_union_variant_list, 3),
